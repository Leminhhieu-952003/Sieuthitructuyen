<div class="container">
    ...
    <div class="row g-3">
        <div class="col-md-12 col-lg-8">
            <div class="row g-3">
                <?php 
                // Vòng lặp PHP để lặp qua từng sản phẩm trong danh sách $listProducts
                foreach ($listProducts as $item) {
                    extract($item);
                    // Tạo đường dẫn đầy đủ đến hình ảnh của sản phẩm.
        ...
        <div class="col-md-12 col-lg-4">
            ...
            <!-- Thẻ chứa danh sách các danh mục --> 
                ...
                <div class="card-body">
                    <div class="list-group">
                        ...
                        foreach ($selectCategories as $item) {
                            ...
                            // Vòng lặp PHP để hiển thị các danh mục từ $selectCategories
            ...
            <div class="card card-top10" style="border: 1px solid #78b833ff;">
                ...
                <div class="card-body">
                    <div class="list-group">
                        <?php 
                        // Vòng lặp PHP để hiển thị các sản phẩm yêu thích từ $selectTop10
                        foreach ($selectTop10 as $item) {
                            extract($item);
                            // Phần tử danh sách với hình ảnh sản phẩm và liên kết đến trang chi tiết sản phẩm
